...
namespace Capa_Datos
{
    public class D_Autobus
    {
        ...
        public void InsertarAutobus (E_Autobus Autobus)
        {
            ...
            OracleParameter par1 = new OracleParameter("v_cedula", Autobus.Cedula);
            cmd.Parameters.Add(par1);
            OracleParameter par2 = new OracleParameter("v_marca", Autobus.Marca);
            cmd.Parameters.Add(par2);
            OracleParameter par3 = new OracleParameter("v_modelo", Autobus.Modelo);
            cmd.Parameters.Add(par3);
            OracleParameter par4 = new OracleParameter("v_placa", Autobus.Placa);
            cmd.Parameters.Add(par4);
            OracleParameter par5 = new OracleParameter("v_color", Autobus.Color);
            cmd.Parameters.Add(par5);
            OracleParameter par6 = new OracleParameter("v_año", Autobus.Año);
